...
import 'package:homz/screens/cart/cart_screen.dart';
import 'package:homz/screens/category_products/category_products_screen.dart';
...
import 'package:homz/services/data_streams/all_products_stream.dart';
import 'package:homz/services/data_streams/favourite_products_stream.dart';
...
class _BodyState extends State<Body> {
  final productCategories = <Map>[
    <String, dynamic>{
      ICON_KEY: "assets/icons/bed.svg",
      TITLE_KEY: "Bed",
      PRODUCT_TYPE_KEY: ProductType.Bed,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/chair.svg",
      TITLE_KEY: "Chair",
      PRODUCT_TYPE_KEY: ProductType.Chair,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/table.svg",
      TITLE_KEY: "Table",
      PRODUCT_TYPE_KEY: ProductType.Table,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/kitchen.svg",
      TITLE_KEY: "Kitchen",
      PRODUCT_TYPE_KEY: ProductType.Kitchen,
    },
    <String, dynamic>{
